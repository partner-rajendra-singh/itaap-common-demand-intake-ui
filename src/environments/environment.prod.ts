export const environment = {
  production: false,
  baseUrl: "https://apps.api.it.philips.com",
  redirectUri: 'https://apps.api.it.philips.com/demand-intake-ui/',
  ...
  scope_demand_login: 'api://itaap-demand-intake-prod/demand_login'
};
